...
export const navs: MenuItem[] = [
  ...
  },
  {
    ...
    path: "/metrics",
    autocollapse: true,
    permission: [PERMISSIONS.VIEW_EXCEL],
  },
  {
    id: "admin",
    ...
    children: [
      ...
      },
      {
        ...
        icon:
          <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 24 24">
            <path fill="#000000" d="M12 12a5 5 0 1 0-5-5a5 5 0 0 0 5 5m0 2c-4.42 0-8 2.24-8 5v1h16v-1c0-2.76-3.58-5-8-5m6.5-2.5a3.5 3.5 0 1 0-2.45-5.99a6.9 6.9 0 0 1 0 5a3.5 3.5 0 0 0 2.45.99m1.5 2.5c-.61 0-1.19.06-1.74.16c1.57 1.04 2.74 2.5 2.74 4.34v.5H24v-.5c0-2.49-1.79-4.63-4-4.5"/>
          </svg>,
        path: "/jefes-zona",
        autocollapse: true,
        permission: [PERMISSIONS.MANAGE_USERS],
